...
public class StepDefNoteCheck extends BaseClass 
{
	...
	public void user_can_able_to_see_the_logout_message() {
		...
		String actuallogoutmessage = driver.findElement(By.xpath("//h1[text()=\"You have logged out of Evernote.\"]")).getText();
